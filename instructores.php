...
<html>
    <head>
        ...
        <title>Cantidad de instructores</title>
    ...
    <body>  
        ...
        <table id="instructores" cellpadding="2" cellspacing="2" border="2">
            ...
            <?php
                $consulta = "SELECT * FROM general WHERE instructor=TRUE AND ubicacion=\"COORDINACIÓN DE SUPERVISIÓN DE FABRICACIÓN DE TRENES\";";
                $hacerConsulta = mysql_query($consulta, $conexion);
                $numeroDeRegistros = mysql_num_rows($hacerConsulta);
                $total=$total+$numeroDeRegistros;
            ?>
            ...
            <?php
                $consulta = "SELECT * FROM general WHERE instructor=TRUE AND ubicacion=\"COORDINACIÓN DE PROGRAMACIÓN Y EVALUACIÓN\";";
                $hacerConsulta = mysql_query($consulta, $conexion);
                $numeroDeRegistros = mysql_num_rows($hacerConsulta);  
                $total=$total+$numeroDeRegistros;
            ?>
            ...
            <?php
                $consulta = "SELECT * FROM general WHERE instructor=TRUE AND ubicacion=\"COORDINACIÓN DE MANTENIMIENTO SISTEMÁTICO ZARAGOZA\";";
                $hacerConsulta = mysql_query($consulta, $conexion);
                $numeroDeRegistros = mysql_num_rows($hacerConsulta);  
                $total=$total+$numeroDeRegistros;
            ?>
            ...
            <?php
                $consulta = "SELECT * FROM general WHERE instructor=TRUE AND ubicacion=\"COORDINACIÓN DE MANTENIMIENTO TLAHUAC\";";
                $hacerConsulta = mysql_query($consulta, $conexion);
                $numeroDeRegistros = mysql_num_rows($hacerConsulta); 
                $total=$total+$numeroDeRegistros;
            ...
            <?php
                $consulta = "SELECT * FROM general WHERE instructor=TRUE AND ubicacion=\"SUBGERENCIA DE MANTENIMIENTO SISTEMÁTICO II\";";
                $hacerConsulta = mysql_query($consulta, $conexion);
                $numeroDeRegistros = mysql_num_rows($hacerConsulta);   
                $total=$total+$numeroDeRegistros;
            ?>
            ...
            <?php
                $consulta = "SELECT * FROM general WHERE instructor=TRUE AND ubicacion=\"COORDINACIÓN DE MANTENIMIENTO SISTEMÁTICO ROSARIO\";";
                $hacerConsulta = mysql_query($consulta, $conexion);
                $numeroDeRegistros = mysql_num_rows($hacerConsulta);  
                $total=$total+$numeroDeRegistros;
            ?>
            ...
            <?php
                $consulta = "SELECT * FROM general WHERE instructor=TRUE AND ubicacion=\"COORDINACIÓN DE MANTENIMIENTO SISTEMÁTICO LA PAZ\";";
                $hacerConsulta = mysql_query($consulta, $conexion);
                $numeroDeRegistros = mysql_num_rows($hacerConsulta);  
                $total=$total+$numeroDeRegistros;
            ?>
            ...
            <?php
                $consulta = "SELECT * FROM general WHERE instructor=TRUE AND ubicacion=\"COORDINACIÓN DE MANTENIMIENTO SISTEMÁTICO TICOMAN\";";
                $hacerConsulta = mysql_query($consulta, $conexion);
                $numeroDeRegistros = mysql_num_rows($hacerConsulta); 
                $total=$total+$numeroDeRegistros;
            ?>
            ...
            <?php
                $consulta = "SELECT * FROM general WHERE instructor=TRUE AND ubicacion=\"COORDINACIÓN DE MANTENIMIENTO SISTEMÁTICO CD. AZTECA\";";
                $hacerConsulta = mysql_query($consulta, $conexion);
                $numeroDeRegistros = mysql_num_rows($hacerConsulta);   
                $total=$total+$numeroDeRegistros;
            ?>
            ...
            <?php
                $consulta = "SELECT * FROM general WHERE instructor=TRUE AND ubicacion=\"COORDINACIÓN DE MANTENIMIENTO MAYOR ZARAGOZA\";";
                $hacerConsulta = mysql_query($consulta, $conexion);
                $numeroDeRegistros = mysql_num_rows($hacerConsulta); 
                $total=$total+$numeroDeRegistros;
            ?>
