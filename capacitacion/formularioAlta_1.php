...
<body>
    ...
    <form  action="formAlta_1.php" method="POST">
        <table>
             <tr><td><LABEL for="expediente">Expediente: </LABEL> </td><td><input type="text" name="expediente" value="<?php echo $expediente; ?>"/></td></tr>
             <tr><td><LABEL for="nombre">Nombre: </LABEL></td><td><input type="text" name="nombre" value="<?php echo $nombre; ?>"/></td></tr>
             <tr><td><LABEL for="puesto">Puesto: </LABEL></td><td><input type="text" name="puesto"/></td></tr>
            ...
            <tr><td><LABEL for="plaza">Plaza: </LABEL></td><td><input type="text" name="plaza"/></td></tr>
            <tr><td><LABEL for="side">Siden:</LABEL></td><td><input type="text" name="siden"/></td></tr>
            ...
            <tr><td><LABEL for="area">ÁREA:</LABEL></td><td><input type="text" name="area"/></td></tr>
            <tr><td><LABEL for="horario">Horario:</LABEL></td><td><input type="text" name="horario" placeholder='EJEMPLO:07:00 A 15:00'/></td></tr>
            <tr><td><LABEL for="descanso">Descanso: </LABEL></td><td><input type="text" name="descanso" placeholder='EJEMPLO: S Y D, L Y M.'/></td></tr>
            ...
            <tr><td><LABEL for="extension">Extension: </LABEL></td><td><input type="text" name="extension"/></td></tr>
            <tr><td><LABEL for="correo">Correo: </LABEL></td><td><input type="text" name="correo"/></td></tr>
