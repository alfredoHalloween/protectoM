...
<html>	
    <head>
      <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        ...
        <title>INFORMACIÓN POR TALLER</title>
        <link href="css/movil.css" rel="stylesheet" type="text/css">
        <link href="css/estiloscorreo.css" rel="stylesheet" type="text/css">
...
<body>
      ...
      <table>
         <td style=" font-size:15px; color:orange;text-align:  left; background: steelblue; border: 1000px;">
...
<div id="contenedorform">
      ...
      <form class="contact_form" action="filtroTaller.php" method="POST">
          <ul>
        <label for="taller">UBICACIÓN:</label>
        <select name='taller'>
